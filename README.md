...
Example of graphs to create:
![Graph using a talbe x-axis](https://github.com/tomca12/Production-Data-Analyser/blob/main/EXAMPLES/Example2/graph2(table)_sample.png)
